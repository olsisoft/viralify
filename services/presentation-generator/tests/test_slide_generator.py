...
class TestSlideModel:
    ...
    def test_title_slide_creation(self):
        ...
        slide = Slide(type=SlideType.TITLE, title="Introduction", content="Subtitle here", index=0)
    ...
    def test_code_slide_with_block(self):
        ...
        code_block = CodeBlock(code="print('Hello')", language="python", filename="example.py")

        slide = Slide(type=SlideType.CODE, title="Code Example", code_blocks=[code_block], index=2)
    ...
    def test_diagram_slide(self):
        ...
        slide = Slide(type=SlideType.DIAGRAM, title="Architecture", diagram_type="architecture", index=3)
...
class TestCodeBlockModel:
    ...
    def test_code_block_with_filename(self):
        ...
        block = CodeBlock(code="console.log('Hello');", language="javascript", filename="example.js")
    ...
    def test_code_block_with_highlight_lines(self):
        ...
        block = CodeBlock(code="def hello():\n    print('Hello')", language="python", highlight_lines=[1, 2])
...
class TestEdgeCases:
    ...
    def test_empty_slide_title(self):
        ...
        slide = Slide(type=SlideType.CONTENT, title="", content="Content without title", index=1)
    ...
    def test_very_long_title(self):
        ...
        slide = Slide(type=SlideType.TITLE, title=long_title, content="Subtitle", index=0)
    ...
    def test_many_bullet_points(self):
        ...
        slide = Slide(type=SlideType.CONTENT, title="Many Points", bullet_points=bullets, index=1)
    ...
    def test_multiple_code_blocks(self):
        ...
        slide = Slide(type=SlideType.CODE, title="Multiple Languages", code_blocks=blocks, index=1)
...
class TestAllSlideTypesWithAllStyles:
    ...
    def test_slide_type_style_combination(self, slide_type, style):
        ...
        slide = Slide(type=slide_type, title=f"Test {slide_type.value} slide", content="Test content", index=0)

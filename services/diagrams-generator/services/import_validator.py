...
class ImportValidator:
    ...
    VALID_IMPORTS: Dict[str, Set[str]] = {
        ...
        "diagrams.ibm.security": {
            "ApiGateway",
            "Appid",
            "BeyondTrustPrivilegedAccessManagement",
            "CloudHsmV2",
            "DataShield",
            "KeyProtect",
            "Secrets",
        ...
        "diagrams.ibm.applications": {
            ...
            "ApiDocs",
            "AppConnectivity",
            "ApplicationForIbmCloud",
            "BlankApp",
            "DataConnector",
            "Devops",
            "EnterpriseApplications",
            "EnterpriseMessagingForIbmCloud",
            "EventScheduler",
            "HostedApplicationForIbmCloud",
            "Launch",
            "OpenSourceAppsForIbmCloud",
            "Parse",
            "PersonalityInsights",
            "ProductRecommendations",
            "SaasIntegrationWithHybridCloud",
            "Salesforce",
            "ServiceDiscovery",
            "Streaming",
            "StreamingAnalytics",

...
class VQVAnalysisResult:
    ...
    def get_all_anomalies(self) -> List[Anomaly]:
        ...
        return self.acoustic_result.anomalies + self.linguistic_result.anomalies + self.semantic_result.anomalies

    def get_critical_anomalies(self) -> List[Anomaly]:
        """Retourne les anomalies critiques"""
        return [a for a in self.get_all_anomalies() if a.severity == SeverityLevel.CRITICAL]

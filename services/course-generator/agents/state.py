...
def create_planning_state_from_orchestrator(
    ...
    return PlanningState(
        ...
        lesson_elements_enabled=orchestrator_state.get("lesson_elements_enabled", {}),
...
def create_orchestrator_state(
    ...
    **kwargs
    ...
    return OrchestratorState(
        ...
        number_of_sections=kwargs.get("number_of_sections", 4),
        lectures_per_section=kwargs.get("lectures_per_section", 3),
        lesson_elements_enabled=kwargs.get("lesson_elements_enabled", {}),

...
class CognitiveBlueprint:
    ...
    def _calculate_duration(self):
        all_steps = self.analysis_phase + self.design_phase + self.implementation_phase + self.validation_phase
        self.total_duration_seconds = sum(s.estimated_duration_seconds for s in all_steps)

    @property
    def all_steps(self) -> List[CognitiveStep]:
        return self.analysis_phase + self.design_phase + self.implementation_phase + self.validation_phase

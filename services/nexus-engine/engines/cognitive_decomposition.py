...
class CognitiveDecompositionAlgorithm:
    ...
    def decompose(self, request: NexusRequest) -> Tuple[ArchitectureDNA, CognitiveBlueprint]:
        ...
        logger.info(
            f"Decomposition complete: {len(dna.entities)} entities, "
    ...
    def _phase_synthesis(self, request: NexusRequest, domain_data: Dict, flows_data: Dict) -> Dict:
        """
        ...
        if complexity == "high":
            refined = self._refine_architecture_with_llm(request, domain_data, flows_data, framework, patterns, layers)
            if refined:
                return refined
    ...
    def _calculate_complexity(self, num_entities: int, num_flows: int, request: NexusRequest) -> str:
    ...
    def _select_framework(self, language: str, complexity: str, audience: TargetAudience) -> str:
    ...
    def _select_patterns(self, domain_data: Dict, complexity: str, request: NexusRequest) -> List[str]:
    ...
    def _refine_architecture_with_llm(
        self,
    ...
    def _phase_planning(
        self, request: NexusRequest, domain_data: Dict, flows_data: Dict, architecture_data: Dict
    ) -> Dict:
        """
...
JSON only."""
            ...
            messages = [
                LLMMessage(
                    role="system", content="Expert coding instructor. JSON only. Focus on the specific concept."
                ),
    ...
    def _build_cognitive_blueprint(self, dna: ArchitectureDNA, blueprint_data: Dict) -> CognitiveBlueprint:

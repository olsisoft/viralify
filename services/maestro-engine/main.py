    ...
    async def generate_course(
        ...
        for i, module in enumerate(learning_path.modules):
            ...
            for j, concept in enumerate(module_concepts):
                ...
                update_progress(job_id, progress, "content_generation", f"Generating: {concept.name}...")
        ...
        total_duration = sum(sum(l.estimated_duration_minutes for l in m.lessons) for m in learning_path.modules)
